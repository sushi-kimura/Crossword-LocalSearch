...
class Puzzle:
    ...
    def saveImage(self, data, fpath, dpi=100, fp=None):
        """
    ...
    def saveProblemImage(self, fpath="problem.png", dpi=100, fp=None):
        """
        ...
        self.saveImage(data, fpath, dpi, fp)

    def saveAnswerImage(self, fpath="answer.png", dpi=100, fp=None):
        """
